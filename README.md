# Vue Resizable Table (+vue-tables-2) 

[![GitHub license](https://img.shields.io/badge/license-MIT-blue.svg)](https://raw.githubusercontent.com/lovleshpokra/v-table-resizable/master/LICENSE) 

[Click here](https://lovleshpokra.github.io/v-table-resizable/) to see the client component in action.
[DEMO](https://lovleshpokra.github.io/v-table-resizable/)
...
```bash
npm install v-table-resizable
```

Require the script:

```js
import {ServerTable, ClientTable, Event} from 'v-table-resizable';
```
...
If you are not using NPM you can also import the minified version found in `dist/v-table-resizable.min.js`.
Copy the file into your project and import it:

```html
<script src="/path/to/v-table-resizable.min.js"></script>
```
...
texts | Object | see the `texts` object in [defaults.js](https://github.com/lovleshpokra/v-table-resizable/blob/master/lib/config/defaults.js)</code>
...
resizable | String | The key used for enable resizing. For enable resizing from headers of table use 'th' and for enabling resizing in all td/th columns use 'table' as values | false


### Credits

Credit for the main codebase is to [Matanya's Vue Table 2](https://github.com/matfish2/vue-tables-2). Thanks, Matanya for creating such a wonderful component. I've taken a fork from the repository and added additional functionality to it.
